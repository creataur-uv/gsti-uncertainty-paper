...
def cross_val_scores(
    ...
    while i < num_Folds:
        ...
        model = nn.Sequential(
            bnn.BayesLinear(prior_mu=0, prior_sigma=0.1, in_features=num_PC, out_features=64),
            nn.ReLU(),
...
# for trait=leaf_traits[0]:
    ...
    for num_PC in range(1, 50):
        ...
        to_DB["trait"] = trait
        to_DB["mlra"] = "CV_PCA_BNN_64_32_16"

        # # Data to Data Base
        print("Saving to Data Base")
        DB_Name = f"data/output/CV_PCA_BNN_64_32_16.db"
