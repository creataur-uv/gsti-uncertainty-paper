...
def cross_val_scores(
    ...
    while i < num_Folds:
        ...
        kernel = gpytorch.kernels.ScaleKernel(gpytorch.kernels.MaternKernel(nu=2.5, ard_num_dims=train_X.size(-1)))
...
# for trait=leaf_traits[0]:
    ...
    for num_PC in range(1, 50):
        ...
        to_DB["trait"] = trait
        to_DB["mlra"] = "CV_PCA_GPR_MATERN_5_2"

        # Data to Data Base
        print("Saving to Data Base")
        DB_Name = f"data/output/CV_PCA_GPR_MATERN_5_2.db"
